#ifndef __GAALET_PGA3_LOGARITHM_H
#define __GAALET_PGA3_LOGARITHM_H
#pragma once

//
// Specialized version of the logarithm function for the PGA algebra, for even grade multivectors and scalars
// For PGA, a motor may be expressed as:
...
namespace pga3 { namespace detail {
    ...
    struct logarithm<A, 1> : public expression<logarithm<A>> {
       ...
       typedef typename insert_element<I_CONF,
        ...
        {
            if(first_eval) {
                element_t s1 = a.template element<0>();
                element_t p1 = a.template element<pseudoscalar_conf>();
...
/**
 * Only implemented for even grade PGA3 multivectors.
 */
/// @ingroup ga_ops
template <class A>
...
#endif // __GAALET_PGA3_LOGARITHM_H
